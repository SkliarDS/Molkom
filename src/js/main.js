...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const navSubMenus = document.querySelectorAll('.nav__sub-menu'); 
    let navLinks = document.querySelectorAll('.nav__btn');   
    ...
    mobMenu.addEventListener('click', function(e){
        if(!e.target.classList.contains('nav__btn')){
            ...
            navSubMenus.forEach(item => item.classList.remove('active'));
